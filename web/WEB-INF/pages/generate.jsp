                    ...
                    <div class="box box-primary">
                        ...
                        <form enctype="multipart/form-data" id="add_form" role="form">
                            <div class="box-body">
                                ...
                                <div class="form-group col-md-6 form-inline">
                                    <label style="width:6%;">密码:</label>
                                    <input type="text" name="password" class="form-control" style="width:93%;"  placeholder="密码">
                                </div>
                                <div class="form-group col-md-6 form-inline">
                                    <label style="width:6%;">工资:</label>
                                    <input type="text" name="salary" class="form-control" style="width:93%;"  placeholder="工资">
                                </div>
...
<script>
    ...
    $('#submitBtn').click(function () {
        ...
        $.ajax({
            url:"/HRM_SSM_war_exploded/employee",
            type:"POST",
            data:formData,
            processData:false,
            contentType:false,
